...
function separateElementsByType(arr: (number | string | boolean)[]): { numbers: number[], strings: string[], booleans: boolean[] } {
...
// Example usage:
const mixedArray: (number | string | boolean)[] = [1, 'hello', true, 42, 'world', false, 3.14];
